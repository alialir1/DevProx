...
--   This Is The Source Channel @GVVVV6 .   --
--                - DevProx -                 --
--        -- https://t.me/GVVVV6 --         --
------------------------------------------------ 
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'GVVVV6')..')'..' ❩\n⌁︙تم رفعه ❨ '..DEV_ABBAS..' ❩ بنجاح', 1, 'md')
...
if mrabs == "مميز" and VipMem(msg) then
Dev_Abs(msg.chat_id_, msg.id_, 1, '⌁︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'GVVVV6')..')'..' ❩\n⌁︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abs(msg.sender_user_id_, msg.id_, 1, '⌁︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "GVVVV6")..')', 1, 'md') 
...
{{text = '⌁ DevProx TeAM .',url="t.me/GVVVV6"}},
}
...
ConstructorAbs = "["..Abs.first_name_.."](T.me/"..(Abs.username_ or "GVVVV6")..")"
else 
...
os.execute('wget https://raw.githubusercontent.com/alialir1/DevProx/master/DevProx.lua') 
dofile('DevProx.lua') 
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/alialir1/DevProxFiles/master/getfile.json")
if res == 200 then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/alialir1/DevProxFiles/master/DevProxFiles/"..FileName)
if Res == 200 then
